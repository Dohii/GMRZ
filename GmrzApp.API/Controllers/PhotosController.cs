...
namespace GmrzApp.API.Controllers
{
    ...
    public class PhotosController : ControllerBase
    {
        ...
        public PhotosController(IGamersRepository repo, IMapper mapper, IOptions<CloudinarySettings> cloudinaryConfig)
        {
        ...
        public async Task<IActionResult> AddPhotoForUser(int userId, [FromForm]PhotoForCreationDto photoForCreationDto){
            ...
            if(await _repo.SaveAll()){
                ...
                // nazalost ne radi jer core 3.0+ nesto je pokvario pfff ne znam sta
